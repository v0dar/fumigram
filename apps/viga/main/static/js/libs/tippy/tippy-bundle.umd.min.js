! function (t, e) {
    ...
    .tippy-box{position:relative;background-color:#222633;color:#fff;-webkit-border-radius: 6px;-moz-border-radius: 6px;font-size:14px;line-height:1.4; white-space:normal;outline:0;transition-property:transform,visibility,opacity}
    ...
    .tippy-arrow{width:16px;height:16px;color:#222633}
