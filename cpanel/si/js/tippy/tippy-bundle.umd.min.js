! function (t, e) {
    ...
    .tippy-box{position:relative;background-color:#3F4656;color:#fff;-webkit-box-shadow: rgba(0, 0, 0, .45) 0 0 8px -10px;-moz-box-shadow: rgba(0, 0, 0, .45) 0 0 8px -5px;box-shadow: rgba(0, 0, 0, .45) 0 0 8px -5px;-webkit-border-radius: 5px;-moz-border-radius: 5px;font-size:14px;line-height:1.4; white-space:normal;outline:0;transition-property:transform,visibility,opacity}
    ...
    .tippy-arrow{width:16px;height:16px;color:#3F4656}
